...
import seederData from "./wallet.seeder.json";
...
const WalletSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WalletSeederDialogComponent);
