...
import seederData from "./promotions.seeder.json";
...
const PromotionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PromotionsSeederDialogComponent);
