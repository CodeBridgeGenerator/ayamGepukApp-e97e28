...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">phone_Number</label><p className="m-0 ml-3" >{Number(_entity?.phoneNumber)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">password_hash</label><p className="m-0 ml-3" >{_entity?.passwordHash}</p></div>
