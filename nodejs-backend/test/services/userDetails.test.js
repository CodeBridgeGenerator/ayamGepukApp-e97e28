...
describe("userDetails service", async () => {
  ...
  describe("#create", () => {
    const options = {"name":"new value","userId":23,"phoneNumber":23,"email":"new value","passwordHash":"new value"};
...
assert.strictEqual(userDetailCreated.userId, options.userId);
...
assert.strictEqual(userDetailCreated.passwordHash, options.passwordHash);
  ...
  describe("#update", () => {
    const options = {"name":"updated value","userId":100,"phoneNumber":100,"email":"updated value","passwordHash":"updated value"};
...
assert.strictEqual(userDetailUpdated.userId, options.userId);
