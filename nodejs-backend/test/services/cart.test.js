...
describe("cart service", async () => {
  ...
  describe("#create", () => {
    const options = {"cartId":"new value","userId":"new value","productId":"new value","quantity":23};
...
assert.strictEqual(cartCreated.userId, options.userId);
...
assert.strictEqual(cartCreated.quantity, options.quantity);
  ...
  describe("#update", () => {
    const options = {"cartId":"updated value","userId":"updated value","productId":"updated value","quantity":100};
...
assert.strictEqual(cartUpdated.userId, options.userId);
